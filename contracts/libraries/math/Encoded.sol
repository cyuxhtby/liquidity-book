 ...
 */
 ...
 /// @dev functions perform bitwise operations to set and decode portions of bytes32 encoding for given offset
 
library Encoded {
    /// @dev bitmasks used for bitwise operations
    uint256 internal constant MASK_UINT1 = 0x1; // one bit for bool value
    uint256 internal constant MASK_UINT8 = 0xff; // 8 bits for uint8
    uint256 internal constant MASK_UINT12 = 0xfff; // 12 bits for uint12
    uint256 internal constant MASK_UINT14 = 0x3fff; // 14 bits etc ..
