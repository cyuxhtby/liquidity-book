...
library PairParameterHelper {
    ...
    /// @dev sets the offsets based on bit slots layed out above
    ...
    /// @dev each f represents four bits in binary (1111) , there are 28 fs, so 112 bits in total (14 bytes)
    /// @dev this allows for easier manipulation first 14 bytes while leaving the last 18 of our bytes32 untouched
    /// @dev so `base factor` through `max volatility accumulator` are within range of this bitmask
    uint256 internal constant MASK_STATIC_PARAMETER = 0xffffffffffffffffffffffffffff;

      ///////////////////////////////////////
    ///@dev getter functions paramater values 
    ////////////////////////////////////////
    ...
    ////////////////////////////////////////////////
    ///@dev setter functions for updating parameters
    //////////////////////////////////////////////
    ...
    /////////////////////////////////////////////////////
    /// @dev Update functions for parameters adjustments
    ////////////////////////////////////////////////////
